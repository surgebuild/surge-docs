...
### Rollup Execution
The platform supports multiple VMs, including ZkVM with RISC Zero and MoveVM, with planned extensions to other VMs to enhance flexibility. This allows rollups to fully support the existing ecosystem without requiring changes. You can find more details on multi-VM support [here](/docs/pages/building-blocks/multi-vm.mdx).
