...
Tracking and Verification of Surge Transactions
When a transaction associated with Surge is identified, the Indexer extracts crucial details, including:

The sender's public key (P<sub>sender</sub>)
The transaction's signature (S)
The corresponding data blob (B)
