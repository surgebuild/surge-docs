...
<img className="md:w-[60%] mx-auto" src="/assets/multisig.png" alt="multisig" />
...
<img src="/assets/mpc-tss.png" alt="mpc tss" />
...
_Source:_ [https://mmasmoudi.medium.com/an-overview-of-multi-party-computation-mpc-threshold-signatures-tss-and-mpc-tss-wallets-4253adacd1b2](https://mmasmoudi.medium.com/an-overview-of-multi-party-computation-mpc-threshold-signatures-tss-and-mpc-tss-wallets-4253adacd1b2)
